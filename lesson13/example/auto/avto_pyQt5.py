...
mf = uic.loadUi("lesson13\\example\\auto\\avto.ui") # форма созданная в программе Qt Designer
...
# читаем файл
df = pd.read_csv('lesson13\\example\\auto\\auto.csv', sep=";", names=["name", "model", "year1", "year2"])
